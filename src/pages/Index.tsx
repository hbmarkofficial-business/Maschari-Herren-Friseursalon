  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Maschari Herrenfriseursalon</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Maschari Herrenfriseursalon in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Maschari Herrenfriseursalon | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Maschari Herrenfriseursalon | Premium Barbershop Berlin" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Barbershop",
            "name": "Maschari Herrenfriseursalon",
